<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AddFl.aspx.cs" Inherits="ZhouZiyang0325SkySharkWebApplication.BM.AddFl" %>
        ...
        <div class="tabContents">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtNoOfBusiSeats" ErrorMessage="Business Fares Required"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="txtBusiClassFare" ErrorMessage="RequiredFieldValidator"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td></td>
