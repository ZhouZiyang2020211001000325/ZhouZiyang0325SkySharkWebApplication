<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ConfirmRes.aspx.cs" Inherits="ZhouZiyang0325SkySharkWebApplication.LOB.ConfirmRes" %>
        ...
        <div class="tabContents">
            <table>
                ...
                <tr>
                    <td></td>
                    <td>
                        <asp:Button ID="btnCancel" runat="server" Text="Submit" />
                    </td>
                    <td></td>
