<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CreateRes.aspx.cs" Inherits="ZhouZiyang0325SkySharkWebApplication.LOB.CreateRes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="form1" runat="server">
        <asp:Menu ID="Menu1" runat="server" BackColor="#F7F6F3" DynamicHorizontalOffset="2" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#7C6F57" Orientation="Horizontal" StaticSubMenuIndent="10px">
            ...
            <Items>
                <asp:MenuItem Text="Create Reservation" Value="Create Reservation" NavigateUrl="~/LOB/CreateRes.aspx" Selected="True"></asp:MenuItem>
        ...
        <div class="tabContents">
            <table>
                <tr>
                    <td colspan="2">
                        <asp:Label ID="Label1" runat="server" Text="Mangge User Account"></asp:Label>
                    </td>
                    <td></td>
                    <td></td>
                </tr>
                ...
                <WizardSteps>
                    <asp:WizardStep ID="WizardStep1" runat="server" Title="Search Flight">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Calendar ID="Cal1" runat="server" BackColor="White" BorderColor="Black" BorderStyle="Double" BorderWidth="2px"></asp:Calendar>
                                </td>
                                <td></td>
                                <td></td>
                            </tr>
                    ...
                    <asp:WizardStep ID="WizardStep2" runat="server" Title="Find Flight Fare&amp;Status">
                        ...
                        <table>
                            <tr>
                                <td colspan="3">
                                    <asp:Label ID="Label6" runat="server" Text="Step2:Confirm flight status and fare with the customer" BorderStyle="Inset" Font-Names="Microsoft Sans Serif"></asp:Label></td>
                    ...
                    <asp:WizardStep runat="server" Title="Make Reservation">
                        ...
                        <table>
                            ...
                            <tr>
                                <td></td>
                                <td>
                                    <asp:Button ID="btnCreate" runat="server" Text="Create Reservation" BackColor="Silver" BorderColor="Blue" Font-Names="Microsoft Sans Serif" /></td>
                                <td>
                                    <asp:Button ID="btnCancel" runat="server" Text="Cancel" BackColor="Silver" BorderColor="Blue" Font-Names="Microsoft Sans Serif" /></td>
                                <td></td>
                            </tr>
                        </table>
                    </asp:WizardStep>
